...
if(MaxSP < SP) MaxSP = SP;
    ...
    { switch(ByteCode[IP])
        {
// Functions:
          case   cAdd: --SP; if(MaxSP < SP) MaxSP = SP; break;
          case   cSub: --SP; if(MaxSP < SP) MaxSP = SP; break;
          case   cMul: --SP; if(MaxSP < SP) MaxSP = SP; break;
          case   cDiv: --SP; if(MaxSP < SP) MaxSP = SP; break;
          case   cSin: break;
          case   cCos: break;
          case   cPow: --SP; if(MaxSP < SP) MaxSP = SP; break;
          case   cPOw: --SP; if(MaxSP < SP) MaxSP = SP; break;
          case   cExp: break;
          case   cNeg: break;
          case cFloor: break;
          case   cAbs: break;
// Misc:
          case cImmed: ++SP; if(MaxSP < SP) MaxSP = SP; break;
          case  cJump: break;
          case  cAcos: break;
#ifndef NO_ASINH
          case cAcosh: break;
...
#endif
          case  cAtan: break;
          case cAtan2: --SP; if(MaxSP < SP) MaxSP = SP; break;
#ifndef NO_ASINH
          case cAtanh: break;
#endif
          case  cCeil: break;
          ...
          case  cEval: break;
#endif
          case    cIf: --SP; if(MaxSP < SP) MaxSP = SP; break;
          case   cInt: break;
          case   cLog: break;
          case cLog10: break;
          case   cMax: --SP; if(MaxSP < SP) MaxSP = SP; break;
          case   cMin: --SP; if(MaxSP < SP) MaxSP = SP; break;
          case   cSec: break;
          case  cSinh: break;
          case  cSqrt: break;
          case   cTan: break;
          case  cTanh: break;
// Operators:
          case     cMod: --SP; if(MaxSP < SP) MaxSP = SP; break;
          case   cEqual: --SP; if(MaxSP < SP) MaxSP = SP; break;
          case    cLess: --SP; if(MaxSP < SP) MaxSP = SP; break;
          case cGreater: --SP; if(MaxSP < SP) MaxSP = SP; break;
          case     cAnd: --SP; if(MaxSP < SP) MaxSP = SP; break;
          case      cOr: --SP; if(MaxSP < SP) MaxSP = SP; break;
...
#ifdef SUPPORT_OPTIMIZER
          case   cVar: break;
          case   cDup: ++SP; if(MaxSP < SP) MaxSP = SP; break;
          case   cInv: break;
#endif
// Variables:
          default: ++SP; if(MaxSP < SP) MaxSP = SP;
        }
    }
...
SPtmppt[i] = data->FuncParsers[index]->Eval(&SPtmppt[i]);
          usedvariable = -1; break;
#ifdef SUPPORT_OPTIMIZER
          case   cVar: usedvariable = -1; break;
          case   cDup: Stack[SP+1] = Stack[SP]; ++SP; usedvariable = -1; break;
          case   cInv:
              if(Stack[SP] == 0.0) { evalErrorType=1;}
